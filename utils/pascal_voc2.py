...
class pascal_voc(object):
    def __init__(self, phase, rebuild=False):
        self.devkil_path = os.path.join(cfg.PASCAL_PATH, 'slab')
        self.data_path = os.path.join(self.devkil_path, 'Pic')
        self.cache_path = cfg.CACHE_PATH
        self.batch_size = cfg.BATCH_SIZE
        self.image_size = cfg.IMAGE_SIZE
        self.cell_size = cfg.CELL_SIZE
        self.classes = cfg.CLASSES
        self.clslen = len(cfg.CLASSES)
    ...
    def get(self):
        ...
        labels = np.zeros((self.batch_size, self.cell_size, self.cell_size, 5+self.clslen))
        count = 0
    ...
    def load_pascal_annotation(self, index):
        ...
        label = np.zeros((self.cell_size, self.cell_size, 5+self.clslen))
